      ...
      try {
        ...
        setErrors({
          ...
          submit:
            ...
            "Errore di connessione o durante l'invio.",
        });
      } finally {
    ...
    <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        <div className="bg-gray-800 p-6 rounded-lg mb-6">
          <h3 className="text-xl font-semibold mb-4 text-[#ebdaa8]">
              ...
              <div>
                ...
                <p
                  ...
                  dangerouslySetInnerHTML={{
                    __html: decodeHtml(eventData.title.rendered),
                  }}
                ></p>
                <p className="text-sm text-gray-400">
                  {/* CORREZIONE 2 & 3: Assicurati che genere e durata_minuti siano nel tipo BaariaEvent */}
                  {eventData.genere} |{" "}
                  {Math.floor(eventData.durata_minuti / 60)}h{" "}
                  {eventData.durata_minuti % 60}min
                </p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div>
                <p className="font-medium text-gray-100">
                  {projectionData.location_nome}
                </p>
                <p className="text-sm text-gray-400">
                  {projectionData.location_indirizzo},{" "}
                  {projectionData.location_citta}
                </p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div>
                <p className="font-medium text-gray-100">
                  {projectionData.data_formattata} - Ore:{" "}
                  {projectionData.orario}
                </p>
              </div>
            </div>
            <div className="flex items-start">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full p-3 bg-gray-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-[#ebdaa8] ${
                  errors.name
            ...
            <button
              ...
              className={`w-full py-3 mt-2 bg-[#ebdaa8] text-[#2d2d2d] rounded-md font-bold hover:bg-opacity-90 transition-colors duration-200 text-lg ${
