...
import { ArrowRight, Film, Clock, Ticket, CheckCircle2, Tag, CalendarDays, Download, ChevronDown } from 'lucide-react';
    ...
    events.forEach(event => {
      if (event.event_details?.programmazione?.length > 0) {
        event.event_details.programmazione.forEach(projection => {
          ...
          flattened.push({ event, projection, adjustedSortKey: getAdjustedSortKey(originalKey) });
        });
      }
    });
        ...
        <div className="top-0 bg-white bg-opacity-90 backdrop-blur-sm z-10 py-3">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              {/* FILTRO DESKTOP: Pulsanti in linea */}
